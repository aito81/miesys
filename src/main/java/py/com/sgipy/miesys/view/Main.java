...
import py.com.sgipy.miesys.util.LazyProvider;
import py.com.sgipy.miesys.util.MyTheme;
import py.com.sgipy.miesys.util.NavigationBar;
import py.com.sgipy.miesys.util.PageTitleUpdater;
...
public class Main extends HorizontalLayout {
	...
	private void SetupNavigator() {
		...
		navigator = new Navigator(MiesysUI.getCurrent(), content);
